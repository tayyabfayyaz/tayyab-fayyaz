...
function ProjectSection(){
    return(
        <main>
            <div className="project-container w-full h-fit py-10 bg-zinc-900 px-10 lg:px-0">
                ...
                <div className="project-img-box w-full px-2 lg:px-40">
                    <div className="project-img w-full h-fit my-10 px-2 lg:py-2 block lg:flex">
                        <div className="img-box-1 relative mr-5 my-5 lg:my-0">
                            <Image src="/img2.jpg" alt="Project" width={400} height={400} className="mr-5 h-[300px] w-[400px] object-cover" />
                        ...
                        <div className="img-box-2 relative mr-5">
                            <Image src="/img3.jpg" alt="Project" width={400} height={400} className="mr-5 h-[300px] w-[600px] object-cover" />
                            <div className="hover-text absolute inset-0 bg-yellow-400 bg-opacity-50 lg:opacity-0 lg:hover:opacity-100 transition-opacity duration-300 py-20">
                    ...
                    <div className="project-img w-full h-fit lg:my-10 px-2 lg:py-2 block lg:flex">
                        <div className="img-box-1 relative mr-5 my-5 lg:my-0">
                            <Image src="/img4.jpg" alt="Project" width={400} height={400} className="mr-5 h-[300px] w-[600px] object-cover" />
                            <div className="hover-text absolute inset-0 bg-yellow-400 bg-opacity-50 lg:opacity-0 lg:hover:opacity-100 transition-opacity duration-300 py-20">
                        ...
                        <div className="img-box-2 relative mr-5 my-5 lg:my-0">
                            <Image src="/img5.jpg" alt="Project" width={400} height={400} className="mr-5 h-[300px] w-[300px] object-cover" />
                            <div className="hover-text absolute inset-0 bg-yellow-400 bg-opacity-50 lg:opacity-0 lg:hover:opacity-100 transition-opacity duration-300 py-20">
                    ...
                    <div className="project-img w-full h-fit my-10 px-2 lg:py-2 block lg:flex">
                        <div className="img-box-1 relative mr-5">
                            <Image src="/img6.jpg" alt="Project" width={400} height={400} className="mr-5 h-[300px] w-[900px] object-cover" />
                            <div className="hover-text absolute inset-0 bg-yellow-400 bg-opacity-50 lg:opacity-0 lg:hover:opacity-100 transition-opacity duration-300 py-20">
